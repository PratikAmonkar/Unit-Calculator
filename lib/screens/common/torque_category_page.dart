...
class TorqueCategoryPage extends StatefulWidget {
  const TorqueCategoryPage({Key? key}) : super(key: key);

  @override
  State<TorqueCategoryPage> createState() => _TorqueCategoryPageState();
}

class _TorqueCategoryPageState extends State<TorqueCategoryPage> {
  String firstIntialDropDownValue = 'dyne meter';
  String secondIntialDropDownValue = 'kg force meter';
  ...
  void convertData() {
    if (firstTextControllerValue.text.isEmpty) {
      ...
      setState(
        () {
          secondTextControllerValue.text = torqueUnitConverte(
