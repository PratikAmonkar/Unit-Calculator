...
import 'package:unit_converter/functions/binary_unit_convert.dart';
...
class BinaryCodeCategoryPage extends StatefulWidget {
  const BinaryCodeCategoryPage({Key? key}) : super(key: key);

  @override
  State<BinaryCodeCategoryPage> createState() => _TorqueCategoryPageState();
}

class _TorqueCategoryPageState extends State<BinaryCodeCategoryPage> {
  String firstIntialDropDownValue = 'binary';
  String secondIntialDropDownValue = 'decimal';
  ...
  void convertData() {
    if (firstTextControllerValue.text.isEmpty) {
      ...
      setState(
        () {
          secondTextControllerValue.text = binaryUnitConverte(
