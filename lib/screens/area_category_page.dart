...
import 'package:unit_converter/functions/area_unit_convert.dart';
import 'package:unit_converter/widgets/alertbox_widget.dart';

class AreaCategoryPage extends StatefulWidget {
  const AreaCategoryPage({Key? key}) : super(key: key);

  @override
  State<AreaCategoryPage> createState() => _AngleCategoryPageState();
}

class _AngleCategoryPageState extends State<AreaCategoryPage> {
  String firstIntialDropDownValue = 'acres';
  String secondIntialDropDownValue = 'hectares';
  ...
  void convertData() {
    if (firstTextControllerValue.text.isEmpty) {
      ...
      setState(
        () {
          secondTextControllerValue.text = areaUnitConverte(
